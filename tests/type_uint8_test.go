...
func TestEncryptedUint8(t *testing.T) {
	expected := gc.EncryptedUint8{
		Raw: 42,
	}
	var actual gc.EncryptedUint8
...
func TestNullEncryptedUint8(t *testing.T) {
	expected := gc.NullEncryptedUint8{
		Raw: 42,
	}
	var actual gc.NullEncryptedUint8
...
func TestSignedUint8(t *testing.T) {
	expected := gc.SignedUint8{
		Raw: 42,
	}
	var actual gc.SignedUint8
...
func TestNullSignedUint8(t *testing.T) {
	expected := gc.NullSignedUint8{
		Raw: 42,
	}
	var actual gc.NullSignedUint8
...
func TestSignedEncryptedUint8(t *testing.T) {
	expected := gc.SignedEncryptedUint8{
		Raw: 42,
	}
	var actual gc.SignedEncryptedUint8
...
func TestSignedEncryptedUint8Tampered(t *testing.T) {
	...
	err = actual.Scan(tamperWith(signed, suppressError(gc.EncryptedUint8{}.Value())))
	if err != nil {
		t.Error(err)
	}
...
func TestNullSignedEncryptedUint8(t *testing.T) {
	expected := gc.NullSignedEncryptedUint8{
		Raw: 42,
	}
	var actual gc.NullSignedEncryptedUint8
