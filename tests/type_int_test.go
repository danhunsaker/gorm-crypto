...
func TestEncryptedInt(t *testing.T) {
	expected := gc.EncryptedInt{
		Raw: 42,
	}
	var actual gc.EncryptedInt
...
func TestNullEncryptedInt(t *testing.T) {
	expected := gc.NullEncryptedInt{
		Raw: 42,
	}
	var actual gc.NullEncryptedInt
...
func TestSignedInt(t *testing.T) {
	expected := gc.SignedInt{
		Raw: 42,
	}
	var actual gc.SignedInt
...
func TestNullSignedInt(t *testing.T) {
	expected := gc.NullSignedInt{
		Raw: 42,
	}
	var actual gc.NullSignedInt
...
func TestSignedEncryptedInt(t *testing.T) {
	expected := gc.SignedEncryptedInt{
		Raw: 42,
	}
	var actual gc.SignedEncryptedInt
...
func TestSignedEncryptedIntTampered(t *testing.T) {
	...
	err = actual.Scan(tamperWith(signed, suppressError(gc.EncryptedInt{}.Value())))
	if err != nil {
		t.Error(err)
	}
...
func TestNullSignedEncryptedInt(t *testing.T) {
	expected := gc.NullSignedEncryptedInt{
		Raw: 42,
	}
	var actual gc.NullSignedEncryptedInt
