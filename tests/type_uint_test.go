...
func TestEncryptedUint(t *testing.T) {
	expected := gc.EncryptedUint{
		Raw: 42,
	}
	var actual gc.EncryptedUint
...
func TestNullEncryptedUint(t *testing.T) {
	expected := gc.NullEncryptedUint{
		Raw: 42,
	}
	var actual gc.NullEncryptedUint
...
func TestSignedUint(t *testing.T) {
	expected := gc.SignedUint{
		Raw: 42,
	}
	var actual gc.SignedUint
...
func TestNullSignedUint(t *testing.T) {
	expected := gc.NullSignedUint{
		Raw: 42,
	}
	var actual gc.NullSignedUint
...
func TestSignedEncryptedUint(t *testing.T) {
	expected := gc.SignedEncryptedUint{
		Raw: 42,
	}
	var actual gc.SignedEncryptedUint
...
func TestSignedEncryptedUintTampered(t *testing.T) {
	...
	err = actual.Scan(tamperWith(signed, suppressError(gc.EncryptedUint{}.Value())))
	if err != nil {
		t.Error(err)
	}
...
func TestNullSignedEncryptedUint(t *testing.T) {
	expected := gc.NullSignedEncryptedUint{
		Raw: 42,
	}
	var actual gc.NullSignedEncryptedUint
